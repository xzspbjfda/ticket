					...
					<view class="tab-panel">
						...
						<view class="tab-panel-item tab-active">
							<view class="flex flex-mar b-line">
								<view class="hotel-city">{{ address.hotel }}</view>
								<view class="flex-box hotel-text">
									我的附近
							...
							<view class="b-line checkinout">
								<view class="firstSelect" style="width:100%;">
									<view class="Date_lr" style="float:left;">
										<p>入住</p>
										<input value="2020-06-25" type="text" disabled />
									</view>
									<span class="calendar-days">
										共
										<span class="NumDate">1</span>
										晚
									</span>
									<view class="Date_lr" style="float:right;">
										<p>离店</p>
										<input value="2020-06-26" type="text" disabled />
									</view>
								</view>
							</view>
							...
							<view class="flex flex-mar b-line">
								...
								<view class="flex-box"><input type="text" class="flex-search" placeholder="名称/位置/品牌" /></view>
							</view>
							...
							<view class="flex-button-box"><button class="flex-button-btn">酒店查询</button></view>
						</view>
						<!-- 酒店预订 end -->
					</view>
				</view>
