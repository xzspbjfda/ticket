 ...
 */
// 个人信息
const memberInfo = '/member/select';
// 个人信息修改
const memberUpdate = '/member/update';

// 收货地址列表
const addressList = '/memberaddress/select';
// 默认收货地址
const addressDefault = '/tiny-shop/v1/member/address/default';
// 默认收货地址
const addressDetail = '/memberaddress/getinfo';
// 创建收货地址
const addressCreate = '/memberaddress/insert';
// 修改收货地址
const addressUpdate = '/memberaddress/update';
// 修改收货地址
...
// 获取我的订单
const sellorderList = '/shopsellorder/select';
// // 订单确认收货
...
// 获取我的订单
const orderList = '/shoporder/myorder';
// 订单确认收货
const orderTakeDelivery = '/tiny-shop/v1/member/order/take-delivery';
// 退货/退款申请
const orderRefundApply = '/tiny-shop/v1/member/order-product/refund-apply';
...
const closeOrderRefundApply = '/tiny-shop/v1/member/order-product/refund-close';
// 获取订单详情
const orderDetail = '/shoporder/getinfo';
// 删除已关闭订单
const orderDelete = '/tiny-shop/v1/member/order/delete';

// 获取我的足迹
const footPrintList = '/shopmemberfootprint/select';
// 删除我的足迹
...
// 积分余额日志
const creditsLogList = '/member/credits';
...
// 上传图片
const uploadImage = '/common/image';
...
// 未读消息个数
const notifyUnRreadCount = '/member/unreadcount';
// 消息提醒配置
