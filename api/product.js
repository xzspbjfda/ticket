 ...
 */
// 首页列表
const indexList = '/indexlist/select';
// 自定义首页列表
const customIndexList = '/tiny-shop/v1/index/custom';
// 积分商城
const integralIndex = '/tiny-shop/v1/index/integral';
// 产品分类列表
const productCate = '/shopproductcate/select';
const productCateChild = '/tiny-shop/v1/product/cate/child';
// 首页推荐分类
const productCateList = '/tiny-shop/v1/product/cate/list';
// 产品列表
const productList = '/shopproduct/select';
// 产品详情
const productDetail = '/shopproduct/getinfo';
// 组合套餐详情
...
// 添加购物车
const cartItemCreate = '/shopmembercartitem/insert';
// 购物车列表
const cartItemList = '/shopmembercartitem/select';
// 购物车列表
const cartItemCount = '/shopmembercartitem/get_count';
// 删除购物车商品
const cartItemDel = '/shopmembercartitem/delete';
// 清空购物车
const cartItemClear = '/shopmembercartitem/clear';
// 修改购物车商品数量
const cartItemUpdateNum = '/shopmembercartitem/update';
// 修改购物车商品sku
...
// 订单创建
const orderCreate = '/shoporder/insert';
// 订单预览
const orderPreview = '/shoporderpreview/getinfo';
// 取消未支付订单
const orderClose = '/shoporder/order_close';
// 订单支付
const orderPay = '/common/paycreate';
// 选择快递运费计算
