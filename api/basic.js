...
// 获取省市区列表
const provinceList = '/commonprovince1/select';
// 收藏商品
...
// 配置
const configList = '/common/configpaytype';

// 充值
const payCreate = '/common/paycreate';
...
// 公告
// 公告列表
const notifyAnnounceIndex = '/shopbasenotify/select';
// 公告详情
const notifyAnnounceView = '/shopbasenotify/getinfo';

// 版本检测
const versionsIndex = '/app-versions/versions/index';
// 升级记录
const versionsView = '/app-versions/versions/view';
