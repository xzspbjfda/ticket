	...
	<view class="wrap">
		<view class="sticky">
			...
			<view class="sticky-post">
				<u-button type="default" size="mini" plain shape="circle" :custom-style="{ borderColor: themeColor.color, color: themeColor.color }"  @click="navTo('/pages/pet/fabu-post')">我要发布</u-button>
			</view>
		</view>
...
import MyPetMescrollItem from './mescroll-item/my-fabu-mescroll-item';
