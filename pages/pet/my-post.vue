	...
	<view class="wrap">
		<view class="sticky">
			...
			<view class="sticky-post">
				<u-button type="default" size="mini" plain shape="circle" :custom-style="{ borderColor: themeColor.color, color: themeColor.color }"  @click="navTo('/pages/pet/forum-post')">我要发贴</u-button>
			</view>
		</view>
		...
		<swiper :current="swiperCurrent" @transition="swiperTransition" @animationfinish="swiperAnimationfinish" :style="{ height: systemInfo.screenHeight + 'px' }">
			<swiper-item v-for="(item, index) in tabs" :key="index">
				<my-post-mescroll-item ref="mescrollItem" :i="index" :index="index" :tabs="tabs"></my-post-mescroll-item>
			</swiper-item>
		</swiper>
...
import MyPostMescrollItem from './mescroll-item/my-post-mescroll-item';
