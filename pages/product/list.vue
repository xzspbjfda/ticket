	...
	<view class="container product-list">
		<view class="rf-header-box">
			<view class="rf-header">
				<view class="rf-back" @tap="back">
					<text class="iconfont iconzuo" style="margin-top: -12rpx;"></text>
				</view>
		...
		<view class="rf-header-screen" :style="{top:32+'px'}">
			<view class="rf-screen-top">
				...
				<!--下拉选择列表--综合-->
				<view class="rf-dropdownlist" :class="[selectH>0?'rf-dropdownlist-show':'']" :style="{height:selectH+'rpx'}">
		...
		<view class="product-list-wrapper">
				<rf-product-list :bottom="0" :list="productList" :isList="isList" :style="{paddingTop: 100 + 'rpx' }"></rf-product-list>
		</view>
		<rf-load-more
			:status="loadingType"
