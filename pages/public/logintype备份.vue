<template>
	<view class="login-wrapper">
		<image class="bg" :src="imageURL"></image>
...
<!-- #ifdef MP-WEIXIN -->
			<button class="handler regin" open-type="getPhoneNumber" shape="circle" :disabled="btnLoading"
				...
				<image style="width: 40rpx; height: 40rpx" src="@/static/login/icon-login8-weixin.png"></image>
...
<!-- #endif -->
			...
			<view class="look-wrapper">
				...
				<text style="margin-left: 10rpx" @tap="handleRfProtocolPopupShow">登录表示同意《{{appName}}协议》</text>
